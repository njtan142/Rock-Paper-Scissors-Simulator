...
function gamelooper(rounds){
    ...
    var p1 = document.createTextNode(player1 + " has won " + winsplayer1 + " rounds!!!")
    var p2 = document.createTextNode(player2 + " has won " + winsplayer2 + " rounds!!!")
    var d = document.createTextNode(draws + " Draws!!!");
   
    r1.setAttribute("id", "gamelooper");
    r2.setAttribute("id", "gamelooper");
    r3.setAttribute("id", "gamelooper");
    r4.setAttribute("id", "gamelooper");
